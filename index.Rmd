...
df <-
  ...
  group_by(state) %>%
  mutate(
    totalActualCases = cumsum(dailyEstimatedActualCases),
...
The purpose of this site is to present COVID-19 trends in the United States in a clear and hopefully useful way, using graphs that show estimated actual cases, hospitalizations, and deaths over time for each state and for the whole country.
...
Navigate the site by using the tabs at the top of the page or the drop-down menu on mobile devices.
...
fig <-
  ...
  add_trace(x = ~date, y = ~totalActualCases, type = "scatter", mode = "lines", color = I("red"), yaxis = "y2", name = "Total", showlegend = TRUE) %>%
...
Test Positive Rate {data-orientation=rows}
=====================================  
...
Estimated Actual Cases {data-orientation=rows}
=====================================  
...
fig <-
  ...
  add_trace(x = ~date, y = ~dailyPositiveTestsAverage, type = "scatter", mode = "lines", color = I("black"), name = "Daily Confirmed", line = list(dash = "dash"), showlegend = TRUE) %>%
  add_trace(x = ~date, y = ~totalActualCases, type = "scatter", mode = "lines", color = I("red"), yaxis = "y2", name = "Total Actual", showlegend = TRUE) %>%
  add_trace(x = ~date, y = ~totalPositiveTests, type = "scatter", mode = "lines", color = I("red"), yaxis = "y2", name = "Total Confirmed", line = list(dash = "dash"), showlegend = TRUE) %>%
  layout(xaxis = list(title = FALSE, fixedrange = TRUE),
...
fig <-
  ...
  add_trace(x = ~date, y = ~dailyPositiveTestsAverage/populationUnitedStates*100000, type = "scatter", mode = "lines", color = I("black"), name = "Daily Confirmed", line = list(dash = "dash"), showlegend = TRUE) %>%
  add_trace(x = ~date, y = ~totalActualCases/populationUnitedStates*100000, type = "scatter", mode = "lines", color = I("red"), yaxis = "y2", name = "Total Actual", showlegend = TRUE) %>%
  add_trace(x = ~date, y = ~totalPositiveTests/populationUnitedStates*100000, type = "scatter", mode = "lines", color = I("red"), yaxis = "y2", name = "Total Confirmed", line = list(dash = "dash"), showlegend = TRUE) %>%
  layout(xaxis = list(title = FALSE, fixedrange = TRUE),
...
Hospitalizations {data-orientation=rows}
=====================================  
...
fig <-
  ...
  add_trace(x = ~date, y = ~totalDeaths, type = "scatter", mode = "lines", color = I("red"), yaxis = "y2", name = "Total", showlegend = TRUE) %>%
  layout(xaxis = list(title = FALSE, fixedrange = TRUE),
         yaxis = list(title = "Daily Deaths (7 Day Average)", side="left", automargin = TRUE, fixedrange = TRUE),
         yaxis2 = list(title = "Total Deaths", titlefont = list(color = "red"), tickfont = list(color = "red"), side="right", overlaying = "y", automargin = TRUE, fixedrange = TRUE),
         legend = list(orientation = "h", xanchor = "center", yanchor = "top", x = 0.5, y = 1.1),
         hovermode = "compare") %>%
  config(displayModeBar = FALSE)
...
fig <-
  ...
  layout(xaxis = list(title = FALSE, fixedrange = TRUE),
         yaxis = list(title = "Daily Deaths Per 100K (7 Day Average)", side="left", automargin = TRUE, fixedrange = TRUE),
