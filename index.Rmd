...
fig <- fig %>% layout(yaxis = list(title = "Estimated Actual Daily Cases"))
...
fig <- fig %>% layout(legend = list(orientation = 'v'))
fig <- fig %>% layout(yaxis = list(title = "Estimated Actual Total Cases"))
fig <- fig %>% layout(xaxis = list(titlefont = list(size = 22), tickfont = list(size = 16)),
                      yaxis = list(titlefont = list(size = 22), tickfont = list(size = 16)),
                      legend = list(font = list(size = 16)))
fig
...
fig <- fig %>% layout(legend = list(orientation = 'v'))
fig <- fig %>% layout(yaxis = list(title = "Hospitalized Currently"))
fig <- fig %>% layout(xaxis = list(titlefont = list(size = 22), tickfont = list(size = 16)),
                      yaxis = list(titlefont = list(size = 22), tickfont = list(size = 16)),
                      legend = list(font = list(size = 16)))
fig
...
fig <- fig %>% layout(legend = list(orientation = 'v'))
fig <- fig %>% layout(yaxis = list(title = "Total Deaths"))
fig <- fig %>% layout(xaxis = list(titlefont = list(size = 22), tickfont = list(size = 16)),
                      yaxis = list(titlefont = list(size = 22), tickfont = list(size = 16)),
                      legend = list(font = list(size = 16)))
fig
...
fig <- fig %>% add_trace(y = ~dailyTestsRollMean, color = I('red'), name = '7 day rolling average')
fig <- fig %>% layout(legend = list(orientation = 'v'))
fig <- fig %>% layout(yaxis = list(title = "Daily Tests"))
fig <- fig %>% layout(xaxis = list(titlefont = list(size = 22), tickfont = list(size = 16)),
                      yaxis = list(titlefont = list(size = 22), tickfont = list(size = 16)),
                      legend = list(font = list(size = 16)))
fig
...
```{r totalTests, echo=FALSE}
fig <- plot_ly(df_US, x = ~date, y = ~totalTests, type = 'scatter', mode = 'lines', color = I('black'), name = 'Daily', width=800)
fig <- fig %>% layout(legend = list(orientation = 'v'))
fig <- fig %>% layout(yaxis = list(title = "Total Tests"))
fig <- fig %>% layout(xaxis = list(titlefont = list(size = 22), tickfont = list(size = 16)),
                      yaxis = list(titlefont = list(size = 22), tickfont = list(size = 16)),
                      legend = list(font = list(size = 16)))
fig
...
fig <- fig %>% layout(legend = list(orientation = 'v'))
fig <- fig %>% layout(yaxis = list(title = "Confirmed Daily Cases"))
fig <- fig %>% layout(xaxis = list(titlefont = list(size = 22), tickfont = list(size = 16)),
                      yaxis = list(titlefont = list(size = 22), tickfont = list(size = 16)),
                      legend = list(font = list(size = 16)))
fig
...
fig <- fig %>% layout(legend = list(orientation = 'v'))
fig <- fig %>% layout(yaxis = list(title = "Total Confirmed Cases"))
fig <- fig %>% layout(xaxis = list(titlefont = list(size = 22), tickfont = list(size = 16)),
                      yaxis = list(titlefont = list(size = 22), tickfont = list(size = 16)),
                      legend = list(font = list(size = 16)))
fig
